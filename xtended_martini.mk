...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="MT2111_IND-user 13 TP1A.220905.001 R.f1ca94-6ed6-6ed5 release-keys" \
    TARGET_DEVICE=$(PRODUCT_SYSTEM_DEVICE) \
    TARGET_PRODUCT=$(PRODUCT_SYSTEM_NAME)

BUILD_FINGERPRINT := OnePlus/MT2111_IND/OP5155L1:13/TP1A.220905.001/R.f1ca94-6ed6-6ed5:user/release-keys

# Xtended Stuff
XTENDED_BUILD_TYPE := OFFICIAL
XTENDED_BUILD_MAINTAINER := Mrick343
XTENDED_BUILD_DONATE_URL := deymrinmoy@paytm
WITH_GAPPS := true
